(function () {
    ...
    define(['../app', './timeUtils'], function (app) {
        ...
        me = '[RedSockClient]';
        ACK_TIMEOUT = 5 * 1000;
        HEARTBEAT_INTERVAL = 8 * 1000;
        HEARTBEAT_TIMEOUT = 17 * 1000;
        MT_DISCONNECT = 0;
        MT_HEARTBEAT = 2;
        MT_EVENT = 3;
        MT_ACK = 4;
            ...
            creator = function (url) {
                ...
                _connect = (function (_this) {
                    return function () {
                        ...
                        _ws.onmessage = function (e) {
                            ...
                            _lastBeat = timeUtils.milliTime();
                            _ref = decodeMessage(e.data), messageType = _ref[0], ackId = _ref[1], name = _ref[2], data = _ref[3];
                            switch (messageType) {
                            case MT_DISCONNECT:
                ...
                _tryReconnect = (function (_this) {
                    return function () {
                        ...
                        if (!_timerReconnect) {
                            _retrial += 1;
                            delay = Math.min(1000 * 0.5 * Math.pow(2, _retrial - 1), 20 * 1000);
